...
if [ $# -ne 1 ]; then
	...
	./atpg -tdfatpg -ndet $1 -compression ../sample_circuits/c6288.ckt > ../tdf_patterns/nieh_c17.pat
	echo "C6288:"
	grep "vector" ../tdf_patterns/nieh_c17.pat
	./atpg -ndet $1 -tdfsim ../tdf_patterns/nieh_c17.pat ../sample_circuits/c6288.ckt > ../tdf_patterns/sim.log
	grep "fault coverage" ../tdf_patterns/sim.log
	grep "generation" ../tdf_patterns/nieh_c17.pat
